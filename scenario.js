...
const scenarioData = {
  relay: {
    ...
    operation: 'OPERATION 17-A', objective: 'Recover the signal core', optional: 'Optional: leave no witnesses', threat: 'SEVERE', reward: '+340 XP', map: 'KHEPRI // 04'
  },
  convoy: {
    ...
    operation: 'OPERATION 22-C', objective: 'Escort the final crawler', optional: 'Optional: recover the black box', threat: 'CRITICAL', reward: '+480 XP', map: 'DUST ROAD // 09'
  },
  blacksite: {
    title: 'Echoes Below',
    ...
    operation: 'OPERATION 31-X', objective: 'Locate the vault architect', optional: 'Optional: extract the forbidden archive', threat: 'UNKNOWN', reward: '+720 XP', map: 'VAULT NULL // 01'
  }
};
